<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Navbar.ascx.cs" Inherits="Enterprise_Computing_AdvancedDB1.Navbar" %>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <asp:PlaceHolder ID="ContosoPlaceHolder" runat="server">
                    <li id="menu" runat="server"><a href="/Contoso/MainMenu.aspx"><i class="fa fa-map-signs fa-lg"></i>Menu</a></li>
